...
<script src='https://cdn.trexle.com/trexle.js'></script>
<script type="text/javascript">
	$(function() {
		...
		var TrexleApi = new Trexle.Api('{$APIKEYPUB}', '{$PINMODE}');
		...
		// Add a submit handler to the form which calls trexle.js to
		...
		form.submit(function(e) {
			...
			TrexleApi.createCardToken(card).then(handleSuccess, handleError).done();
		});
		...
		function handleError(response) {
			...
			errorContainer.show();
			window.location = '#TrexleValError';
...
<div id="TrexleValError" data-alert="" class="alert-box alert" style='display:none'>
